                ...
                <div className="w-screen bg-[#292929] text-white p-8 flex flex-col items-start">
                    <div className="grid grid-cols-2 gap-8">
                        <div>
                            ...
                            <p className="mt-10 text-2xl leading-[2.5] w-[60%]">Para 2028 ser la plataforma número uno en contratación de servicios temporales laborales en Bogotá, destacándonos por nuestra confianza y transparencia.</p>
                        </div>
                ...
                <div className="w-full flex justify-center relative">
                    <div className="absolute top-0 bg-white rounded-lg border border-gray-300 p-4 w-[45%] flex items-start">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-[#666666] text-lg mt-6 mb-6 font-bold">EasyFixy, te da la oportunidad de contratar trabajadores calificados para tus necesidades de servicios cotidianos, de manera rápida, sencilla y eficiente.</p>
                            <Link to="/login" className="text-orange-500 text-2xl underline font-bold mt-8">Ir al sitio</Link>
                        </div>
                    </div>
                    
                    <img src="/icons/loop.svg" alt="loop" className="max-w-full h-auto" />
                    ...
                    <div className="absolute bottom-0 mb-8 bg-white rounded-lg border border-gray-300 p-4 w-[45%] flex items-start mx-auto  ">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-[#666666] text-lg mt-6 mb-6 font-bold">Somos EasyFixy, una plataforma donde conectamos a trabajadores independientes con trabajos cotidianos a su medida, de manera rápida y eficiente.</p>
                            <Link to="/login" className="text-orange-500 text-2xl underline font-bold mt-8">Ir al sitio</Link>
                        </div>
                    </div>
                </div>
