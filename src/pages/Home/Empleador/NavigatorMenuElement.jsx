...
const NaigatorMenuElement = (props) => {
    ...
    return (
        <div className={props.index == props.seccionActiva ? "sm:m-4 sm:p-4 m-2 text-cyan-700 underline cursor-pointer" : "sm:m-4 m-2 sm:p-4 cursor-pointer"}  key={props.index} onClick={handleClick}>
            {props.name}
        </div>
    )
}
