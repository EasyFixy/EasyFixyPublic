...
const NaigatorMenuElement = (props) => {
    ...
    return (
        <div className={props.index == props.seccionActiva ? "m-4 p-4 text-cyan-700 underline cursor-pointer" : "m-4 p-4 cursor-pointer"}  key={props.index} onClick={handleClick}>
            {props.name}
        </div>
    )
}
