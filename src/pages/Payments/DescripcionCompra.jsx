                ...
                <section className="w-[50%]">
                    <div className="flex flex-col h-auto my-20 mr-40 border rounded-2xl border border-black p-4">
                        ...
                        <div className="flex flex-row justify-center mt-8">
                            ...
                            <button className="bg-[#27806C] flex flex-row text-white justify-center items-center px-8 py-2 rounded-3xl ml-8" onClick={next}>Siguiente<img src="/icons/arrow-circle-right.svg" alt="siguiente" /></button>
                        </div>
                    </div>
                </section>
            </div>
