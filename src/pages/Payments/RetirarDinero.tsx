    ...
    <div className="w-screen h-screen flex flex-col overflow-y-auto">
      ...
      <div className="flex-grow flex flex-col items-center mt-8">
        <div className="w-full max-w-xl">
          ...
          <h3 className="text-emerald-700 font-bold mb-4 underline">Tarjeta</h3>
          <div className="rounded-lg overflow-hidden shadow-1 p-6 mx-auto">
            <form className="w-full">
              ...
              <div className="mb-4">
                <label
                  htmlFor="tipoTarjeta"
                  className="block text-emerald-700 text-sm font-bold mb-2 underline"
                >
                  Tipo de tarjeta
                </label>
                <select
          ...
          <div className="rounded-lg overflow-hidden shadow-1">
            <form className="w-full p-6" onSubmit={(e) => { e.preventDefault(); handleRetirar(); }}>
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  type="submit"
                  className="bg-emerald-700 text-white py-2 px-4 rounded hover:bg-emerald-800 focus:outline-none focus:shadow-outline w-1/3"
                >
                  Retirar
                </button>
              </div>
